...
const GlobalStyle = createGlobalStyle`
    :root {
        ...
        --headerbackground: ${(props) => props.theme.lightColor.headerbackground};
        --pointcolor: ${(props) => props.theme.lightColor.pointcolor};
        --subcolor: ${(props) => props.theme.lightColor.subcolor};
